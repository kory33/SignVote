...
public class MessageConfigNodes {
    ...
    private static final String COMMAND_ROOT = "command";
    ...
    private static final String GENERIC_COMMAND_ERROR   = COMMAND_ROOT + ".generic.error";
    ...
    private static final String VOTEPOINT_MESSAGE_ROOT  = "votepoint";
    ...
    private static final String UNVOTE_UI               = UI_ROOT + ".unvote";
    ...
    private static final String LIST_UI                 = UI_ROOT + ".list";
    ...
    private static final String ADDSCORE_UI             = UI_ROOT + ".addscore";
    ...
    private static final String STATS_UI                = UI_ROOT + ".stats";
     ...
     */
    static final String STATS_TYPE_VOTES                = GENERIC + ".votes";
    static final String STATS_TYPE_SCORE                = GENERIC + ".score";
    static final String STATS_TYPE_MEAN                 = GENERIC + ".mean";
}
